...
- Altitude check: in an abstract, introduction, or section opener, any inferential machinery, stacked interval, secondary statistic, or tertiary derived rate has been relocated to its home section rather than left above it. A caveat, a venue-required or precision-carrying interval, or a load-bearing derived metric with no in-scope home was kept or routed to `Author questions`, never silently dropped.

...
| `install.sh` installs only to `.claude/skills/`    | Cross-tool portability requires symlinks into each tool's directory: `~/.codex/skills/`, `~/.gemini/skills/`, `~/.openclaw/skills/`, `.cursor/skills/`, `~/.config/github-copilot/skills/`.                                                                       |
